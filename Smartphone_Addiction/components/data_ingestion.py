...
from Smartphone_Addiction.entity.config_entity import DataIngestionConfig
from Smartphone_Addiction.entity.artifact_entity import DataIngestionArtifact
import sys
import os
import pandas as pd
import numpy as np
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe:pd.DataFrame):
        try:
            ...
            os.makedirs(dir_path, exist_ok=True)
            logging.info("Exporting train and test data file paths")
            train_set.to_csv(self.data_ingestion_config.training_file_path, index=False, header=True)
            test_set.to_csv(self.data_ingestion_config.testing_file_path, index=False, header=True)
            logging.info("Exported train and test data files")
        except Exception as e:
            raise SmartphoneAddictionException(e,sys)
