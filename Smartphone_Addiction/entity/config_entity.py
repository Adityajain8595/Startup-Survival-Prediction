...
import os
from Smartphone_Addiction.constants import training_pipeline
...
class TrainingPipelineConfig:
    def __init__(self, timestamp=datetime.now()):
        ...
        self.training_pipeline_name = training_pipeline.PIPELINE_NAME
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_object_file_path: str = os.path.join(
            self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, training_pipeline.DATA_PREPROCESSING_OBJECT_FILE_NAME
        )
